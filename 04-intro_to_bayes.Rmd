...
\[\theta \sim N(\mu_0 = 1, \sigma_0^2=0.11^2)\]

- **We specify normal prior for log(HR)! The prior distribution of HR**. In probability theory, a lognormal distribution is a continuous probability distribution of a random variable whose logarithm is normally distributed. In this case, HR follows a lognormal distribution!


**3. The posterior of log(HR)**

- Given prior $\theta \sim N(1, 0.11^2)$ and likelihood $y \mid \theta \sim (\theta,0.158^2)$ where $y=log(0.75)=-0.287$
